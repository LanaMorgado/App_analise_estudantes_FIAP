...
with tab0:
    ...
    plt.grid()
    st.pyplot() # para moostrar o código no streamlit

with tab1:
    st.write('### Visão geral por raça e etnia')
    ...
    """
    Analisando o grupo de etnia de estudantes, o grupo c representa a maior proporção de estudantes, representando 31,9% do total.
...
with tab2:
    ...
    """
    O gênero feminino é predominante na base de estudantes, contabilizando 51% da amostra.
...
with tab3:
    ...
    st.write('Estatística básica do grupo de estudantes feminino')
...
with tab4:
    st.write('### Análise de desempenho de notas por diciplina')
